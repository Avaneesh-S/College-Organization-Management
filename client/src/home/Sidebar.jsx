...
function Sidebar() {
  ...
  return (
    <div
      id="sidebar"
      className="border border-slate-500 fixed top-[10%] z-10 h-4/5 left-[-200px] w-[300px] flex flex-col gap-8 justify-between transition-[left] duration-700 rounded-md bg-gray-900/70 backdrop-filter backdrop-blur-md p-4"
    >
      ...
      <SidebarComponents name="Logout" icon="logout" />
    </div>
  );
}
